    ...
    filterOptionsList.push( new FilterOption(
        ...
        function() {
            var relationBlock = document.createElement( 'div' ),
                ...
                relationOptionNone = document.createElement ( 'option' ),
