(function($) {
	...
	$.fn.draw = function(o, obj, selectedPage) {
		if(o.display > o.count)
			o.display = o.count;
		$this.empty();
		var first = $(document.createElement('a')).addClass('pageFirst').html(getMessage('firstNav'));
		if(o.rotate) {
			if(o.images) 
		...
		var last = $(document.createElement('a')).addClass('pagLast').html(getMessage('lastNav'));
